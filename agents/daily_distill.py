...
def get_unprocessed_files() -> list[Path]:
    ...
    Scans both top-level capture/*.md and all subdirectories
    (e.g. capture/clientbrain/<client>/*.md) so that every ingestion
    source is picked up regardless of directory structure.
    """
    files = []
